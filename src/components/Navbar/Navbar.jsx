    ...
    <nav className="z-20 fixed w-full backdrop-blur-md">
      <div className="flex items-center font-medium justify-around">
        ...
        <ul className="md:flex hidden uppercase items-center font-[Poppins]">
          <li>
            <Link to="/" className="py-7 px-5 inline-block hover:border-b-4 hover:border-blue-500">
              Home
            </Link>
          </li>
          <li>
            <Link to="/About" className="py-7 px-5 inline-block hover:border-b-4 hover:border-blue-500">
              About Us
            </Link>
          </li>
          <NavLinks />
